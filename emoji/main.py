...
from fair_model import Model, SimpleModel
...
def main():
    ...
    train([train_loader, valid_loader], model, args)
    ...
    loss, accuracy, fairness, unfairness = test(test_loader, model, args)
    print("*" * 50)
    print("Test Loss: {}\tAccuracy: {}\tFairness: {}\tUnfairness: {}".format(loss, accuracy, fairness, unfairness))
